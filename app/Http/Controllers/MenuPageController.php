...
*/
    ...
    public static function CartDeliverySetting()
    {
        //cart_delivery_settings
        $cart_delivery_settings = \DB::table('cart_delivery_settings')->where('id','1')->first();
        return $cart_delivery_settings;
    }
    ...
    )
    {
          ...
          try {
              ...
              $mail->SMTPAuth = true;
              $mail->Username = 'noreply@themahal.co.uk';
              $mail->Password = 'Kkw_0#$}c4[R';
...
/*
              ...
              $mail->setFrom('noreply@themahal.co.uk', $this->SiteName);
