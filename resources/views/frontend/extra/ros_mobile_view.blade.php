                                                ...
                                                @foreach($optMenu as $rw)
                                                            ...
                                                            <div class="cell-12" style="margin-bottom: 5px; padding: 0px;">
                                                                ...
                                                                <div class="cell-6" style="padding-left: 0px;">
                                                                    <select name="imjnameMobile{{$row->id}}_{{$objSTD->clean($rw->pro_opt_name)}}" data-opt-cond="{{$objSTD->clean($rw->pro_opt_name)}}" class="form-control inmPriceMobile imjMobile{{$row->id}}" data-tag="{{$row->id}}" style="width: 100%;">
