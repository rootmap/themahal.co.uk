<?php 
    ...
    $Seo=$objSTD->Seo();
    $CartDS=$objSTD->CartDeliverySetting();
...
<html>
    <head>
        ...
        <meta name="csrf-mda" content="{{ $CartDS->MINIMUM_FREE_DELIVERY_AMOUNT }}">
        <meta name="csrf-mdac" content="{{ $CartDS->BELOW_ORDER_DELIVERY_CHARGE }}">
        @yield('seo') 
