                            ...
                            <div class="cell-9">
                                <h3 class="center block-head">
                                    <span class="main-intro">
                                        ...
                                        Welcome to the  Mahal Indian  Take-away & home delivery
                                    </span>
                                    <span class="sub-intro">Serving Indian Cuisine to the people of Morden since 1988</span>
                                </h3>
                                <div class="cell-12">
                                ...
                                <!--<div class="cell-12 reserve-headline">
                                        <P>Reserve your table online for a memorable night out at Tandoori Mahal</P>
                                    </div>-->
                                    <div class="cell-12 instruction">
                                        <P>Thank you for choosing a The Mahal take-away meal<br>If your order is not for a specific time or date, please allow 30 minutes<br> for your pick-up from our Takeaway.</P>
                                    </div>
                                    ...
                                    <P class="red-text">-: NOTICE :-</br> Alcoholic drinks will be served or delivered with meals only and paid by credit card. Alcoholic drinks will not be served or delivered to any person under 18 years of age.
To ensure we comply with the liquor licensing law. Proof of Age may be required.The Management reserves the right to refuse service. All major Credit and Debit Cards accepted.</P>
                                    </div>
                                    
                                    <div class="cell-12 instruction">
                                    <!--<P>We aim to honour our 30 minute delivery of orders. An order for three or more people, or during our busy periods Friday & Saturday evenings 6 till 8 - allow 45 minutes for your food order pick-up</P>-->
                                    </br>
                                    <P class="red-text">-: ALLERGIES & INTOLERANCES: :-</br> Some of our dishes contain CELERY, CEREALS CONTAINING GLUTEN, CRUSTACEANS, EGG, FISH, LUPIN,
MILK, MOLLUSCS, MUSTARD, NUTS PEANUTS, SESAME SEEDS, SOYA, SULPHUR DIOXIDE which some peoples may have a reaction to. Please inform our staff before ordering if you suffer from any food allergies.
We will do our best to advise you.</P>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="cell-4 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="grid3column uppercase cus_image">
                                    ...
                                    <a class="btn btn-md btn-3d btn-custom-small fx animated fadeInUp" href="{{url('http://themahal.co.uk/order-item#pro12')}}" data-animate="fadeInUp" data-animation-delay="1700" style="animation-delay: 1700ms;">
                                         Order Online
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="cell-4 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="grid3column uppercase cus_image">
                                    ...
                                    <img alt="" src="{{url('front-theme/images/offer.jpg')}}">
                                    <a class="btn btn-md btn-3d btn-custom-small fx animated fadeInUp" href="{{url('http://themahal.co.uk/our-offer')}}" data-animate="fadeInUp" data-animation-delay="1700" style="animation-delay: 1700ms;">
                                        Order Online
                                    </a>
                                </div>
                            </div>
